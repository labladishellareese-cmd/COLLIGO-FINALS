...
// 4. FETCH TEACHERS
$search_term = '';
$sql = "SELECT user_id, first_name, last_name, email FROM users WHERE role = 'teacher' AND is_approved = 1";

if (isset($_GET['search']) && !empty($_GET['search'])) {
    $search_term = $_GET['search'];
    $like_term = "%" . $search_term . "%";
    // Update SQL to search
    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 p-6 lg:p-10">
            ...
            <header class="flex flex-col md:flex-row justify-between items-center mb-8">
                <h1 class="text-3xl font-bold text-gray-900 mb-4 md:mb-0">Manage Teachers</h1>
            ...
            <div class="bg-white p-4 rounded-xl shadow-md border border-gray-200 mb-6">
                <form action="admin_manage_teachers.php" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div class="flex items-end gap-2">
                        ...
                        <a href="admin_manage_teachers.php" class="w-full text-center bg-gray-200 text-gray-700 py-2 px-4 rounded-md font-semibold hover:bg-gray-300">
                            Reset
                        </a>
                    </div>
                </form>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 text-sm">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200" id="userTableBody">
                            ...
                            <?php else: ?>
                                ...
                                <tr id="user-<?php echo $teacher['user_id']; ?>" class="user-row">
                                    ...
                                    <td class="px-4 py-3 whitespace-nowrap space-x-2">
                                        <a href="admin_edit_teacher.php?id=<?php echo $teacher['user_id']; ?>" class="text-blue-600 hover:text-blue-800 font-medium">Edit</a>
                                        <a href="admin_delete_user.php?id=<?php echo $teacher['user_id']; ?>" 
